            ...
            return s(t, [{
                ...
                value: function(t, e, i) {
                    var s = this.w,
                        ...
                        o = t.label.text;
                    "category" !== s.config.xaxis.type && !s.config.xaxis.convertedCatToNumeric || this.invertAxis || (r = this.getStringX(t.x));
                    ...
                    if (!(r < 0 || r > s.globals.gridWidth)) {
                        if (null === t.x2) {
                            ...
                            if ("category" !== s.config.xaxis.type && !s.config.xaxis.convertedCatToNumeric || this.invertAxis || (c = this.getStringX(t.x2)), c < r) {
                                var d = r;
                                r = c, c = d
                            }
                            if (o) {
            ...
            return s(t, [{
                ...
                value: function(t, e, i) {
                    ...
                    if (n.globals.markers.size[e] > 0 && (l = h.group({
                        ...
                        })).attr("clip-path", "url(#gridRectMarkerMask".concat(n.globals.cuid, ")")), o.x instanceof Array)
