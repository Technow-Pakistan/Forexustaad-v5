...
$(document).ready(function() {
    ...
    $(".h-back-user-list").on("click", function() {
        $(".clientDataMessagesUser").attr("userId",0);
    ...
    $("#search-friends1").on("keyup", function() {
        console.log("hello world");
        var h1 = $(this).val().toLowerCase();
        $(".header-user-list .userlist-box1 .media-body1 .chat-header1").each(function() {
            var g1 = $(this).text().toLowerCase();
            $(this).closest(".userlist-box1")[g1.indexOf(h1) !== -1 ? "show" : "hide"]()
        })
    });
