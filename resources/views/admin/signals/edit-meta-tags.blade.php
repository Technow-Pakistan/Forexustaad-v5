						...
						<div class="row align-items-center">
							<div class="col-md-12">
								<div class="page-header-title">
									<h5 class="m-b-10">Meta Pair</h5>
								</div>
								<ul class="breadcrumb">
									<li class="breadcrumb-item">
										<a href="{{URL::to('ustaad/dashboard')}}"><i class="fa fa-home"></i></a>
									</li>
									<li class="breadcrumb-item"><a href="{{URL::to('ustaad/signals/addPair')}}">Signal Pair</a></li>
									<li class="breadcrumb-item active"><a href="#!">Meta Tags</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="card">
							...
							<div class="card-body">
                                <form action="" method="post" enctype="multipart/form-data">
                                    <label for="">Signal Pair</label>
                                    <input type="text" class="form-control" name="" value="{{$signalPair->pair}}" disabled>
                                    ...
                                    <div class="form-group">
                                        <label for=""><img src="{{URL::to('storage/app')}}/{{$data != null ? $data->image : ''}}" alt="" width="100px" height="100px"></label>
