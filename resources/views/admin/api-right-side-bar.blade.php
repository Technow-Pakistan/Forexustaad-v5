												...
												<tr  draggable="true">
													...
													<td>
														...
														<div class="overlay-edit editlink" value="{{$data->id}}">
															...
															<button type="button" href="{{URL::to('/ustaad/api/api-right/trash')}}/{{$data->id}}" class="btn btn-icon btn-danger addAction" data-toggle="modal" data-target="#myModal"><i class="fa fa-trash"></i></button>
														</div>
													</td>
												</tr>
											@endforeach
...
<script>
	$(".editlink").on("click",function(){
		...
		$(".apiForm").attr("action","{{URL::to('/ustaad/api/api-right/edit/')}}/"+id+"");
		console.log(title);
