                    ...
                    <div class="col-md-12">
                        ...
                        <div class="d-flex justify-content-between">
                            <ul class="breadcrumb p-0 m-0 bg-white">
                                ...
                                <li class="breadcrumb-item"><a href="{{URL::to('/ustaad/post/viewAll')}}">All Post</a></li>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div id="demo{{$idf}}" class="collapse">
                                                                    <form action="{{URL::to('/ustaad/post/CommentViewReply/add')}}" method="post">
                                                                        <textarea class="form-control" name="comment"></textarea>
                                                                        <input type="hidden" name="memberId" value="{{$value['id']}}">
                                                                        <input type="hidden" name="userType" value="admin">
                                                                        <input type="hidden" name="blogId" value="{{$com->blogId}}">
