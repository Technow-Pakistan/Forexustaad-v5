						...
						<div class="row align-items-center">
							<div class="col-md-12">
								<div class="page-header-title">
									<h5 class="m-b-10">Brokers Review</h5>
								</div>
								<ul class="breadcrumb">
												...
												<tr  draggable="true">
													...
													<td>
														...
														<div class="overlay-edit">
															<a href="{{URL::to('/admin/brokersReview/edit')}}/{{$news->id}}"> <button type="button" class="btn btn-icon btn-success"><i class="feather icon-check-circle"></i></button></a>
															<a href="{{URL::to('/admin/brokersReview/delete')}}/{{$news->id}}"><button type="button" class="btn btn-icon btn-danger"><i class="feather icon-trash-2"></i></button></a>
														</div>
													</td>
												</tr>
											@endforeach
