												...
												<tr  draggable="true">
													...
													<td>
														...
														<div class="overlay-edit">
															...
															<a href="{{URL::to('/ustaad/brokersNews/delete')}}/{{$news->id}}" data-toggle="modal" data-target="#myModal" class="addAction"><button type="button" class="btn btn-icon btn-danger"><i class="feather icon-trash-2"></i></button></a>
														</div>
													</td>
												</tr>
											@endforeach
