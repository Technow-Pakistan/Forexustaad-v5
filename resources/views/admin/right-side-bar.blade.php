									...
									<tbody class="border border-primary">
										...
										<tr>
											...
											<td>
												...
												<a href="{{URL::to('/ustaad/banner/right-side-banner/trash')}}/{{$data->id}}" class="addAction" data-toggle="modal" data-target="#myModal">
...
@include('admin.include.footer')
	...
	<script>
		...
		$(".editlink").on("click",function(){
			...
			$(".bannerForm").attr("action","{{URL::to('/ustaad/banner/right-side-banner/edit')}}/"+id+"");
