									...
									<div id="thumb_img" class="cf">
										...
										@foreach($images as $image)
											<img
												...
												onclick="changeimg('{{URL::to('/storage/app')}}/{{$image->image}}','{{URL::to('/admin/edit-slider-image')}}/{{$image->id}}',this);"
											/>
											@php $i++ @endphp
										@endforeach
									</div>
									<a href="{{URL::to('/admin/edit-slider-image')}}/{{$images[0]->id}}" class="text-center" id="detailLink">
