			...
			<div class="pcoded-content">
                ...
                <div class="row">
                    <div class="col-sm-12 col-xl-4 col-md-12 ">
                        <div class="form-wrap">
                            <h5 class="text-dark pb-2">Add New Tag</h5>
                            <form id="addtag" method="post" action="" class="">
                                <div class="form-group">
                                    <label for="tag-name" class="form-control-label">Name</label>
                                    <input name="name" class="form-control " id="tag-name" type="text" value="" size="40" aria-required="true" required>
                                    <small>The name is how it appears on your site.</small>
                                </div>
                                <div class="form-group">
                                    <label for="tag-slug" class="form-control-label">Slug</label>
                                    <input name="slug" id="tag-slug" type="text" class="form-control" value="" size="40" required>
                                    <small>The “slug” is the URL-friendly version of the name. It is usually all lowercase and contains only letters, numbers, and hyphens.</small>
                                </div>
                                <div class="form-group">
                                    <label for="tag-description" class="form-control-label">Description</label>
                                    <textarea name="description" class="form-control" id="tag-description" rows="5" cols="40" required></textarea>
                                    <small>The description is not prominent by default; however, some themes may show it.</small>
                                </div>
                                <p class="submit">
                                    <input type="submit" name="submit" id="submit" class="btn btn-outline-primary" value="Add New Tag"> <span class="spinner"></span>
                                </p>
                            </form>
                        </div>
                    </div>
