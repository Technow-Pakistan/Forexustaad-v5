												...
												<tr  draggable="true">
													...
													<td>
														...
														<div class="overlay-edit editlink" value="{{$data->id}}">
															...
															<a type="button" href="{{URL::to('/ustaad/api/api-home/trash')}}/{{$data->id}}" class="btn btn-icon btn-danger addAction" data-toggle="modal" data-target="#myModal"><i class="feather icon-trash-2"></i></a>
														</div>
													</td>
												</tr>
											@endforeach
