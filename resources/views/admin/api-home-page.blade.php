												...
												<tr  draggable="true">
													...
													<td>
														...
														<div class="overlay-edit editlink" value="{{$data->id}}">
															...
															<button type="button" href="{{URL::to('/ustaad/api/api-home/trash')}}/{{$data->id}}" class="btn btn-icon btn-danger addAction" data-toggle="modal" data-target="#myModal"><i class="fa fa-trash"></i></button>
														</div>
													</td>
												</tr>
											@endforeach
