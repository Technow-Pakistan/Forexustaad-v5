                                ...
                                <div class="form-wrap">
                                    <form method="post" action="" class="" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input name="name" class="form-control" value="{{$video->name}}" type="text" required>
                                        </div>
										<div class="form-group">
                                            <img src="{{URL::to('storage/app')}}/{{$video->thumbnail}}" width="100px" height="100px" alt="">
											<input type="file" class="form-control h-100" name="thumbnail" id="customFile">
										</div>
										<div class="form-group">
											<label for="">Embed Code</label>
											<div>
												<textarea name="embed" id="" class="form-control" required>{{$video->embed}}</textarea>
											</div>
										</div>
										<br>
                                        <p class="submit">
