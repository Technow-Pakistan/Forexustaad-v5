					...
					<!-- <div class="col-md-6 col-xl-3">
						<div class="card bg-c-blue order-card">
							<div class="card-body">
								...
								<p class="m-b-0">
									Completed Orders<span class="float-right">351</span>
								</p>
							</div>
						</div>
					</div> -->
					<div class="col-md-6 col-xl-3">
						<div class="card bg-c-green order-card">
							<div class="card-body">
								...
								<h2 class="text-right text-white">
									<i class="feather icon-tag float-left"></i><span>1641</span>
								</h2>
								<p class="m-b-0">
									This Month<span class="float-right">213</span>
								</p>
							</div>
						</div>
					</div>
					<div class="col-md-6 col-xl-3">
						<div class="card bg-c-yellow order-card">
							<div class="card-body">
								...
								<p class="m-b-0">
									This Month<span class="float-right">$5,032</span>
								</p>
							</div>
						</div>
					</div>
					<div class="col-md-6 col-xl-3">
						<div class="card bg-c-red order-card">
							<div class="card-body">
								...
								<p class="m-b-0">
									This Month<span class="float-right">$542</span>
								</p>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 col-md-12">
						<div class="card overflow-hidden">
							<div class="card-body">
								<h6>Conversions</h6>
								<h4 class="m-0">
									0.85%<span class="text-c-blue ml-2"
										><i class="feather icon-arrow-up"></i>0.50%</span
									>
								</h4>
								<span>Purchased</span>
							</div>
						...
						<div class="card overflow-hidden">
							<div class="card-body">
								<h6>Conversions</h6>
								<h4 class="m-0">
									0.85%<span class="text-c-green ml-2"
										><i class="feather icon-arrow-up"></i>0.50%</span
									>
								</h4>
								<span>Purchased</span>
						...
						<div class="card overflow-hidden">
							<div class="card-body">
								<h6>Conversions</h6>
								<h4 class="m-0">
									0.85%<span class="text-c-red ml-2"
										><i class="feather icon-arrow-up"></i>0.50%</span
									>
								</h4>
								<span>Purchased</span>
									...
									<div class="btn-group card-option">
										...
										>
											...
											<li class="dropdown-item close-card">
												<a href="#!"
													><i class="feather icon-trash"></i> remove</a
												>
											</li>
										</ul>
									</div>
							...
							<div class="card-body">
								<ul class="feed-blog pl-0">
									<li class="active-feed">
										...
										<h6>
											<span class="badge badge-danger">File</span> Eddie
											uploaded new files:
										...
										<div class="row">
											<div class="col-auto text-center">
												<img
													src="{{URL::to('/public/AdminAssets/assets/images/gallery-grid/img-grd-gal-1.jpg')}}"
													alt="img"
											...
											<div class="col-auto text-center">
												<img
													src="{{URL::to('/public/AdminAssets/assets/images/gallery-grid/img-grd-gal-2.jpg')}}"
													alt="img"
													class="img-fluid wid-100"
												/>
											...
											<div class="col-auto text-center">
												<img
													src="{{URL::to('/public/AdminAssets/assets/images/gallery-grid/img-grd-gal-3.jpg')}}"
													alt="img"
													class="img-fluid wid-100"
												/>
									...
									<li class="diactive-feed">
										...
										<h6>
											<span class="badge badge-success">Task</span> Sarah marked
											the Pending Review:
									...
									<li class="diactive-feed">
										...
										<h6>
											<span class="badge badge-primary">comment</span> abc
											posted a task:
					...
					<div class="col-md-12">
						<div class="card table-card">
							<div class="card-header">
								...
								<ul
									class="nav nav-pills nav-fill mt-3 border-bottom pb-3"
									id="pills-tab"
									role="tablist"
								>
									<li class="nav-item">
										<a
											...
											aria-selected="true"
											><i class="feather icon-film m-r-5"></i> Entertainment</a
										>
									</li>
									<li class="nav-item">
										<a
											...
											aria-selected="false"
											><i class="feather icon-file-text m-r-5"></i> CMS</a
										>
									</li>
									<li class="nav-item">
										<a
											...
											aria-selected="false"
											><i class="feather icon-mail m-r-5"></i> Mail</a
										>
									</li>
									<li class="nav-item">
										<a
											...
											aria-selected="false"
											><i class="feather icon-monitor m-r-5"></i> Newslatter</a
										>
									</li>
								</ul>
							</div>
															...
															<th>
																<span
																	...
																	<a
																		...
																		><i
																			class="feather icon-help-circle f-16"
																		></i></a
																></span>
															</th>
															<th>
