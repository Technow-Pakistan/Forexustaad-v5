        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6 col-md-12 order-1 order-lg-2">
                    <div class="family">
                            <div>
                                <h4>Free Signals, Analysis and news updates</h4>
                            </div>
                            ...
                            <div>
                                ...
                                <p>
                                    If you need Free Signals , Analysis and Market updates then sing up Now , InshaAllah you get daily and weekly updates in your e mail box, We try our best to provide you best opportunity in Forex market, so If you need our free signals services , fill this forum
                                </p>
                                <br><br>
                                <div class="container h-100vh pt-5">
                                    <div class="row row h-100 align-items-center justify-content-centerr">
                                        <div class="col align-self-cente ">
                                            <div class="card">
                                                <div class="card-header text-center btn btn-primary colos display-4">
                                                ...
                                                <div class="card-body">
                                                    <form>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <small><a href="https://codepen.io/MKAbuMattar/pen/xxxWmwq?" class="form-text text-muted">I do not have an account!</a></small>
                                                        </div>
